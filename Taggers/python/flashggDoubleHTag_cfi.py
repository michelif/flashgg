...
flashggDoubleHTag = cms.EDProducer("FlashggDoubleHTagProducer",
                                   ...
                                   MVAConfig = cms.PSet(variables=cms.VPSet(), # variables are added below
                                                        ...
                                                        weights=cms.FileInPath("flashgg/Taggers/data/HHbbgg_MVAClassigication_weights_2016.xml"), # path to TMVA weights
                                   ...
                                   MVAFlatteningFileName=cms.untracked.FileInPath("flashgg/Taggers/data/cumulativeTransformation_output_GluGluToHHTo2B2G_node_SM_13TeV-madgraph_2016.root")#FIXME, this should be optional, is it?
                                  ) 
